        ...
        <div className="relative mx-auto grid max-w-7xl items-center gap-12 lg:grid-cols-2">
          <div>
            ...
            <p className="mt-6 max-w-2xl text-lg leading-8 text-neutral-300">
              Lift and level sunken concrete quickly with professional foam slab
              jacking. Our polyurethane foam injection process restores
          ...
          <div className="grid gap-12 lg:grid-cols-2">
            ...
            <div className="space-y-6 text-lg leading-8 text-neutral-700">
              <p>
                ...
                services using high-density polyurethane foam to lift and level
                sunken concrete surfaces quickly and effectively.
              </p>
          ...
          <div className="grid items-center gap-10 lg:grid-cols-2">
            <div>
              ...
              <p className="mt-5 text-lg leading-8 text-neutral-300">
                Contact Desa Foam Insulation today for a free quote and restore
                your driveways, sidewalks, patios, and concrete slabs with
                professional foam slab jacking.
              </p>
            </div>
