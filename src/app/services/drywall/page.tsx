          ...
          <div className="grid gap-12 lg:grid-cols-2">
            ...
            <div className="space-y-6 text-lg leading-8 text-neutral-700">
              ...
              <p>
                ...
                completion, helping every space look professional and ready for
                paint.
              </p>
            </div>
          </div>
            ...
            <article className="overflow-hidden rounded-3xl bg-white shadow-sm">
              ...
              <div className="p-8">
                ...
                <p className="mt-5 leading-8 text-neutral-700">
                  ...
                  ensure each drywall sheet fits properly. We secure the panels
                  to framing using quality fasteners, then tape, mud, and sand
                  the joints for a clean, seamless finish.
                </p>

                <p className="mt-4 leading-8 text-neutral-700">
                  Whether it is a new build or renovation, we prepare walls and
                  ceilings for paint with professional results.
                </p>
              </div>
            </article>
            ...
            <article className="overflow-hidden rounded-3xl bg-white shadow-sm">
              ...
              <div className="p-8">
                ...
                <p className="mt-5 leading-8 text-neutral-700">
                  ...
                  repairs, our team restores surfaces with smooth blending and a
                  clean finish.
                </p>

                <p className="mt-4 leading-8 text-neutral-700">
                  Our repair work is completed quickly, cleanly, and
                  professionally so your space looks refreshed and ready to use.
                </p>
              </div>
            </article>
          </div>
          ...
          <div className="grid items-center gap-10 lg:grid-cols-2">
            <div>
              ...
              <p className="mt-5 text-lg leading-8 text-neutral-300">
                ...
                drywall experts bring your space to life.
              </p>
            </div>
