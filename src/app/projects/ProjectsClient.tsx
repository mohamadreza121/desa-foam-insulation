  ...
  return (
    <main className="bg-white">
          ...
          <div className="grid gap-10 lg:grid-cols-[1.2fr_0.8fr] lg:items-end">
            <div>
              ...
              <p className="mt-6 max-w-3xl text-lg leading-8 text-neutral-300">
                Explore our spray foam insulation, attic insulation, batt
                insulation, drywall, steel framing, fireproofing, and concrete
                lifting work across residential and commercial projects.
              </p>
            </div>
      ...
      <section className="px-6 py-10">
        <div
          className="mx-auto flex max-w-7xl flex-wrap gap-3"
        ...
        <div className="mx-auto grid max-w-7xl gap-12 lg:grid-cols-3">
          {[
            [
              "01",
              "Preparation",
              "We inspect the space, plan the work, and prepare the area for a clean installation.",
            ],
            [
              "02",
              "Installation",
              "Our team completes the service using professional equipment, materials, and attention to detail.",
            ],
            [
              "03",
              "Final Finish",
              "We inspect the work, clean the area, and leave the project ready for its next stage.",
            ],
          ].map(([step, title, text]) => (
            <article
              key={step}
          ...
          <div className="grid items-center gap-10 lg:grid-cols-2">
            <div>
              ...
              <p className="mt-5 text-lg leading-8 text-neutral-300">
                Contact DESA Foam Insulation about your next insulation,
                drywall, framing, fireproofing, or concrete leveling project.
              </p>
            </div>
          ...
          >
            ...
            >
              <Image
                ...
                alt={`${selectedImage.title} by DESA Foam Insulation`}
                width={1400}
                height={900}
